        ...
        chapters: [
          {
            ...
            subchapters: [
              ...
              { id: "attention-pipeline", number: "1.2", title: "The Attention Pipeline" },
              { id: "multi-head",         number: "1.3", title: "Multi-Head Attention & the KV Cache" },
              { id: "positional-encodings", number: "1.4", title: "Positional Encodings" },
              { id: "architectures",      number: "1.5", title: "Architectures & Pretraining" },
              { id: "mlp",                number: "1.6", title: "Inside the MLP" },
              { id: "backprop",           number: "1.7", title: "Backpropagation" },
            ],
          },
          {
            id: "ch-2",
            ...
            subchapters: [
              { id: "icl",            number: "2.1", title: "In-Context Learning" },
              { id: "compute-depth",  number: "2.2", title: "Compute Depth & Chain-of-Thought" },
              { id: "self-consistency", number: "2.3", title: "Self-Consistency" },
              { id: "icl-methods",    number: "2.4", title: "ICL Methods Explorer" },
              { id: "tree-of-thoughts", number: "2.5", title: "Tree of Thoughts" },
            ],
          },
          {
            id: "ch-3",
            ...
            subchapters: [
              { id: "embedding-architecture", number: "3.1", title: "The Architectural Triangle" },
              { id: "bi-encoder",             number: "3.2", title: "Bi-Encoder Mechanics" },
              { id: "two-stage-retrieval",    number: "3.3", title: "Cross-Encoder & Two-Stage Retrieval" },
              { id: "colbert-maxsim",         number: "3.4", title: "ColBERT & MaxSim" },
              { id: "matryoshka",             number: "3.5", title: "Matryoshka Embeddings" },
            ],
          },
        ],
      },
