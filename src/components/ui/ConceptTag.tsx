  ...
  return (
    <span
      className={cn(
        ...
        variant === "default" && "bg-foreground/[0.04] border-foreground/10 text-foreground/85 hover:bg-foreground/[0.08]",
        variant === "highlight" &&
          "bg-violet-500/10 border-violet-500/30 text-violet-200 hover:bg-violet-500/20",
        variant === "muted" && "bg-transparent border-foreground/[0.08] text-foreground-muted",
        className,
      )}
    >
      {children}
