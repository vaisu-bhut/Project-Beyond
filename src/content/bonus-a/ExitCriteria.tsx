const ACCENT = "--accent-bA";

export default function BonusAExitCriteria() {
  return (
  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-foreground-muted font-mono mt-2 opacity-70">
        Edit <span className="text-foreground/85">src/content/bonus-a/ExitCriteria.tsx</span>
      </p>
    </div>
  );
}
