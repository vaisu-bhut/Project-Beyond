const ACCENT = "--accent-p3";

export default function Phase3ExitCriteria() {
  return (
  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-foreground-muted font-mono mt-2 opacity-70">
        Edit <span className="text-foreground/85">src/content/phase-3/ExitCriteria.tsx</span>
      </p>
    </div>
  );
}
