const ACCENT = "--accent-p4";

export default function Phase4ExitCriteria() {
  return (
  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-foreground-muted font-mono mt-2 opacity-70">
        Edit <span className="text-foreground/85">src/content/phase-4/ExitCriteria.tsx</span>
      </p>
    </div>
  );
}
