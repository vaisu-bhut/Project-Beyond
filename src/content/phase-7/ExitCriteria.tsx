const ACCENT = "--accent-p7";

export default function Phase7ExitCriteria() {
  return (
  ...
  return (
    ...
    >
      ...
      <p className="text-[11px] text-foreground-muted font-mono mt-2 opacity-70">
        Edit <span className="text-foreground/85">src/content/phase-7/ExitCriteria.tsx</span>
      </p>
    </div>
  );
}
